...
<div class="mainn">
        ...
        <div class="containerr">
            <div class="signup-content">
                <div class="signup-form">
                    <h2 class="form-title" style="text-align: center;">DEMANDE DE STAGE</h2>
    ...
    @endif           @if ($errors->any())
                    ...
                    @endif
                    <form action="{{ route('demStage.store') }}" method="POST" class="register-form" id="register-form">
                    @csrf
                        ...
                        <div class="form-group">
                            <label for="Période"><i class="zmdi zmdi-email"></i></label>
                            <input type="text" name="Période" id="Période" placeholder="Période"/>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group form-button">
                           <a class="btn btn-primary" href="{{ route('demStage.index') }}"> Back</a>
