                ...
                <div class="crow">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="/assets/img/chaimaa.jpeg" alt="">
                                <!-- Blog Social -->
                            ...
                            <div class="team-caption">
                                <h3><a href="instructor.html">EL ARGOUBI CHAIMAA</a></h3>
                                <p>IAGI CI2</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="/assets/img/hafssa.jpeg" alt="">
                                <!-- Blog Social -->
                                <ul class="team-social">
                                    <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                            ...
                            <div class="team-caption">
                                <h3><a href="instructor.html">JAFRI HAFSSA</a></h3>
                                <p>IAGI CI2</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-team mb-30">
                            ...
                            <div class="team-caption">
                                <h3><a href="instructor.html">BILAL HAJAR</a></h3>
                                <p>IAGI CI2</p>
                            </div>
                        </div>
                    </div>
