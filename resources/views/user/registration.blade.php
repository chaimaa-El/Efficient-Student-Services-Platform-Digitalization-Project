        ...
        <div class="containerr">
            <div class="signup-content">
                <div class="signup-form">
                    ...
                    {{ csrf_field() }}
                        <div class="form-group">
                            ...
                            <input type="text" name="prenom" id="name" placeholder="Votre prénom"/>
                        </div>
                        <div class="form-group">
                            <label for="name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                        ...
                        <div class="form-group">
                            <label for="name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                            <input type="text" name="cne" id="name" placeholder="Votre CNE"/>
                        </div>
                        <div class="form-group">
                            <label for="name"><i class="zmdi zmdi-calendar"></i></label>
                            <input type="text" name="annee" id="name" placeholder="Votre année"/>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="password" id="password" onkeyup='check();'  placeholder="Votre mot de passe"/>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="re_pass" id="confirm_password" onkeyup='check();'  placeholder="Veuillez resaisir le mot de passe"/>
                        </div>
                ...
                <div class="signup-image">
                    ...
                    <a href="{{url('/salut')}}" class="signup-image-link">I am already member</a>
                </div>
            </div>
        </div>
    </section>
