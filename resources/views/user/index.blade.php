                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-6 col-lg-7 col-md-8">
                                <div class="hero__caption">
                                    ...
                                    <!-- Hero-btn -->
                                    <div class="hero__btn">
                                        <a href="{{url('/salut')}}" class="btn hero-btn"  data-animation="fadeInLeft" data-delay=".8s"> Login &nbsp</a>
                                        <a href="{{url('/salut2')}}" class="btn hero-btn"  data-animation="fadeInLeft" data-delay=".8s">Register</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="browse-btn2 text-center mt-50">
                            <a href="courses.html" class="btn">Voir plus</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="/assets/img/hanane.jpeg" alt="">
                                <!-- Blog Social -->
                            ...
                            <div class="team-caption">
                                <h3><a href="instructor.html">Hanane ID-AAMER</a></h3>
